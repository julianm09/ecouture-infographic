document.querySelector("#blueText").innerHTML += BlueTextUI(
  "Choose a material to help save the world!",
  "0"
);

document.querySelector("#buttons").innerHTML += ButtonContainerUI(
  "35",
  "35",
  "15",
  "../comps/Resources/cotton-btn.svg",
  "../comps/Resources/animal-btn.svg",
  "../comps/Resources/plant-btn.svg",
  "../comps/Resources/synthetic-btn.svg",
  "cotton",
  "animal",
  "plant",
  "synthetic"
...
if (localStorage.completedLevels) {
  ...
  const completeAllLevels = Object.values(completedState).every(
    (x) => x === true
  );
